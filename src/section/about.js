...
export const About = (props) => {
  ...
  return (
    ...
    style= {{ background: "linear-gradient(to bottom, #5a9bd4, #4169e1)", 
  }}>
      <div className='flex justify-center items-center content-center pb-4 h-full mt-12 pt-4 '>
        <div className='xl:w-3/5 xl:h-full z-30 shadow-xl rounded-xl bg-no-repeat bg-center bg-cover mt-12 pt-4'
          style={{ backgroundImage: "url('https://raw.githubusercontent.com/JukiSufail/images/main/smile2.jpg')" , height: "130%"}}>
        </div>
      </div>
        ...
        <div className='h-full grid mb-8 lg:mb-0'>
          <div className='justify-self-center self-start mt-5 lg:mt-20 grid w-4/5 lg:w-2/3'>
            <div className='text-white tracking-wide text-lg'>
              ...
              <a href='https://discord.com/' className='border w-full flex items-center rounded border-2 border-indigo-200 border-opacity-10 shadow-xl rounded-xl p-2  bg-opacity-10 hover:bg-opacity-20' style={{ backgroundColor: '#003366' }}>
