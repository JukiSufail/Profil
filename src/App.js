...
<header className='sticky top-0 grid lg:grid-cols-2 z-50 items-center bg-transparent'>
      ...
      <div>
        <div className="text-end p-4 pe-8 hidden lg:block">{/* top right content */}
          <span className='uppercase bg-yellow-200 align-middle me-4 p-1.5 rounded font-semibold text-black' onClick={switchLang}>{lang}</span>
          <a href="https://github.com/JukiSufail" className="text-black">
            <GitHub className="bg-yellow-200 p-1 rounded scale-150" />
          </a>
        </div>
      </div>
    </header>
